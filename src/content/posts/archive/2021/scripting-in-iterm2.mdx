...
archived: true
author: Cody Brunner
canonicalURL: https://blog.codybrunner.com/archive/2021/python-scripting-in-iterm2
categories:
  - technology
...
import image from '../../../../assets/images/2021/scripting-in-iterm2/prompt-1.png'
import imageTwo from '../../../../assets/images/2021/scripting-in-iterm2/prompt-2.png'
...
<div class='flex flex-col items-center justify-center bg-aura-black'>
	<img alt='Prompt One' class='h-96' src={image} />
	<small class='text-aura-gray'>First Prompt</small>
</div>

<div class='flex flex-col items-center justify-center bg-aura-black'>
	<img alt='Prompt Two' class='h-96' src={imageTwo} />
	<small class='text-aura-gray'>Second Prompt</small>
</div>
