...
```yaml:content/posts/rewriting-my-site-with-hugo.md
---
title: 'Rewriting My Site With Hugo'
...
```jsx:components/ProjectList.jsx
const list = [
  { id: 1, name: 'a' },
  { id: 2, name: 'b' },
  { id: 3, name: 'c' },
...
```html:layouts/section/posts.html
