...
archived: true
author: Cody Brunner
canonicalURL: https://blog.codybrunner.com/archive/2017/up-and-running-with-iterm-and-zsh
categories:
  - technology
...
import image from '../../../../assets/images/2017/up-and-running-with-iterm-and-zsh/in_vscode.png'
import imageTwo from '../../../../assets/images/2017/up-and-running-with-iterm-and-zsh/term_left_side.png'
import imageThree from '../../../../assets/images/2017/up-and-running-with-iterm-and-zsh/term_right_side.png'
import imageFour from '../../../../assets/images/2017/up-and-running-with-iterm-and-zsh/term_left_side_2.png'
import imageFive from '../../../../assets/images/2017/up-and-running-with-iterm-and-zsh/term_left_side_3.png'
import imageSix from '../../../../assets/images/2017/up-and-running-with-iterm-and-zsh/term_left_side_4.png'
import imageSeven from '../../../../assets/images/2017/up-and-running-with-iterm-and-zsh/term_left_side_5.png'
...
Now at the time of writing this iTerm2 is at version 3.1.5; why it is not _iTerm3_ I don't really know 😕
...
One of the great things about zsh are the plugins you can utilize to make your life easier as a developer. Adding auto-complete and suggestions alone is a huge boost in productivity and less keystrokes 😉 The best part is that most of these plugins come pre-installed with `oh-my-zsh`. You can find them in `~/.oh-my-zsh/plugins/`. Here are just a few, in my honest opinion, must haves ☺️
...
<div class='flex flex-col items-center justify-center bg-aura-black'>
	<img alt='Terminal Prompt 1' src={imageSeven} />
	<small class='text-aura-gray'>
		Left side of terminal prompt from home directory.
	</small>
</div>
<div class='flex flex-col items-center justify-center bg-aura-black'>
	<img alt='Terminal Prompt 2' src={imageTwo} />
	<small class='text-aura-gray'>
		Left side of terminal prompt with git branch.
	</small>
</div>
<div class='flex flex-col items-center justify-center bg-aura-black'>
	<img alt='Terminal Prompt 3' src={imageThree} />
	<small class='text-aura-gray'>
		Right side of terminal prompt with NodeJS version, Yarn version, time and
		date.
	</small>
</div>
<div class='flex flex-col items-center justify-center bg-aura-black'>
	<img alt='Terminal Prompt 4' src={imageFour} />
	<small class='text-aura-gray'>
		Left side of terminal prompt showing dirty git tree.
	</small>
</div>
<div class='flex flex-col items-center justify-center bg-aura-black'>
	<img alt='Favicon' src={imageFive} />
	<small class='text-aura-gray'>
		Left side of terminal prompt showing tracked files in git tree.
	</small>
</div>
<div class='flex flex-col items-center justify-center bg-aura-black'>
	<img alt='Terminal Prompt 5' src={imageSix} />
	<small class='text-aura-gray'>
		Left side of terminal prompt showing clean git state with commit difference
		from upstream.
	</small>
</div>
<div class='flex flex-col items-center justify-center bg-aura-black'>
	<img alt='Terminal Prompt in VSCode' src={image} />
	<small class='text-aura-gray'>
		Terminal theme applied to VSCode terminal.
	</small>
</div>

## Wrap Up

I am loving the new setup using iTerm2 + zsh. You should give it a try and see how much you enjoy working in your terminal ❤️. You can find my configuration in this [gist](https://gist.github.com/rockchalkwushock/eb0dcb5ecf2c8621d12db7ce0c15fcaa).
