...
archived: true
author: Cody Brunner
canonicalURL: https://blog.codybrunner.com/archive/2018/happy-new-years
categories:
  - personal
createdAt: 02/05/2018
description: Where I've been and where I'm going in 2018.
draft: false
featured: false
language: 'en'
publishedAt: 02/05/2018
title: Happy New Years!
---

import image from '../../../../assets/images/2018/happy-new-years/get-after-it.jpg'
import imageTwo from '../../../../assets/images/2018/happy-new-years/git-commit-meme.png'
...
Some of us are finally starting the year. My 2017 ended, well not so good and spilled over into 2018. There was a fire in my apartment building and I lost quite a bit. Mostly I lost time which I can't get back and insurance won't reimburse 😭 Let me tell you something though, when a firefighter yells out: _"Y'all need to get the @#$% out of here now!"_ the below meme does not hold true at all:

<div class='flex flex-col items-center justify-center bg-aura-black'>
	<img alt='git commit meme' class='h-96' src={imageTwo} />
	<small class='text-aura-gray'>Don't ignore this meme!</small>
</div>

Lost all of the JavaScript blog series I had been working on and a mobile project I had just gotten started on. 😭
...
<div class='flex flex-col items-center justify-center bg-aura-black'>
	<img alt='Get After It!' class='h-96' src={image} />
	<small class='text-aura-gray'>
		My new coffee mug with Jocko's message on it "Get After It!".
	</small>
</div>
...
<Tweet tweetLink='RockChalkDev/status/958018912880414721' />

## Pipeline

I spent a lot of that down time watching tutorials, taking notes, coming up with ideas, _writing code_ (no like literally pen and paper! 😂) and I'm ready to get back to coding! That being said there is a pecking order for things:
...
I hope you all have been having a stellar 2018 and have accomplished a lot already. I might be behind the curve a bit, but look out because here I come! 🚀 😎
