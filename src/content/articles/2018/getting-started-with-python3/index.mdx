...
archived: true
author: cody-brunner
canonicalURL: 'https://blog.codybrunner.com/2018/getting-started-with-python3'
categories:
  - technology
coverImage:
  alt: Photo by SVGPorn
  src: 'https://cdn.svgporn.com/logos/python.svg'
createdAt: 06/20/2018
description: >-
  Installation and setup of Python3 on macOS & development with Visual Studio
  Code.
draft: false
featured: false
publishedAt: 06/20/2018
relatedArticles:
...
For more in depth setup you can go to the VS Code documentation [here](https://code.visualstudio.com/docs/languages/python).
