...
description: In my journey into learning Go I have been learning how to use
  Makefiles within my Go projects. I had never worked with Makefiles before and
  this post will touch on how to use them.
draft: true
featured: false
