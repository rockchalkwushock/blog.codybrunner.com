...
In years past I have experimented with Elixir and I do love the language as well as Phoenix and Phoenix Liveview. So why not double down on Elixir? Albeit the hype around Elixir has definitely grown a lot and that's reflected by the [LINK](). The problem still remains that there are not many job openings that hire for new developers in that space. Most job postings I find are for Seniors, maybe mid-level if I am lucky, and being realistic my Elixir-fu is not that great. I am sure people will argue that it's no different for Go, but I am bullish on this language due to how prevalent it's usage is in DevOps and tooling. Hell just in the JS ecosystem you can find tools like [esbuild]() that were written in Go. Things like [caddy](https://caddyserver.com/), [tailscale](https://tailscale.com/), & [traefik](https://traefik.io/) are all written in Go as well. My decision ultimately came down to [Rust](https://www.rust-lang.org) or [Go](https://go.dev) and I decided that it would be faster and more beneficial to my career to learn Go. Cue the screams of the Rust Andies with "Well Akschully!"
...
I know there are elements to Rust that make it a better and safer language than Go; however the amount of crap you have to go through to get there "hell ta tha nah ta tha nah nah nah!" It makes me feel like I am writing TypeScript again...shots fired?

<Giphy giphyId="u8u0R51ND9L2" />
