...
archived: true
author: cody-brunner
canonicalURL: 'https://blog.codybrunner.com/2017/automating-with-circleci'
categories:
  - technology
coverImage:
  alt: Photo by SVGPorn
  src: 'https://cdn.svgporn.com/logos/circleci.svg'
createdAt: 10/05/2017
description: How to automate your workflow with CircleCi 2.0 & Zeit's Now platform.
draft: false
featured: false
publishedAt: 10/05/2017
relatedArticles:
...
tags:
  - ci-cd
  - deploy
title: Automating With CircleCi
---
...
```shell
mkdir .circleci && touch ./.circleci/config.yaml
```
...
<link
	href="/rockchalkwushock/home/circleci/circleci-deployment/static/css/main.c17080f1.css"
	rel="stylesheet"
/>

<!-- PUBLIC_URL when explicitly set. -->
<link
	href="https://circleci-deployment-beta.now.sh/static/css/main.c17080f1.css"
	rel="stylesheet"
/>
```
