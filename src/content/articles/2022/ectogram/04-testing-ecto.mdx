...
archived: true
author: cody-brunner
canonicalURL: 'https://blog.codybrunner.com/2022/ectogram/04-testing-ecto'
categories:
  - technology
coverImage:
...
description: >-
  Part 4 in the Ectogram series where I cut my teeth on testing the user schema
  with ExUnit.
draft: false
featured: false
...
```elixir showLineNumbers title="test/support/fixtures/user_fixtures.ex"
...
```elixir showLineNumbers title="test/ectogram/user_test.ex"
...
I actually forgot all about enabling this and didn't realize it until writing this post. Yet another thing to _circle back_ too. 🤦🏻‍♂️ We can enable `async` mode by adding the following to our test:

```diff showLineNumbers title="/test/ectogram/user_test.ex"
defmodule Ectogram.UserTest do
- use Ectogram.DataCase
