...
archived: true
author: cody-brunner
canonicalURL: 'https://blog.codybrunner.com/2023/breaking-up-with-bitwarden'
categories:
  - personal
  - technology
coverImage:
  alt: Photo by rc.xyz NFT gallery on Unsplash
  src: ./key.avif
createdAt: 06/22/2023
description: >-
  After Bitwarden's decision to terminate their VP of Software due to his answer
  to preferred pronouns in the workplace, I have decided to move to a different
  password manager.
draft: false
featured: false
publishedAt: 06/25/2023
relatedArticles: []
...
import heroImage from './key.avif'
