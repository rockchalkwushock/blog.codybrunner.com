...
archived: true
author: cody-brunner
canonicalURL: 'https://blog.codybrunner.com/2021/python-scripting-in-iterm2'
categories:
  - technology
coverImage:
...
description: >-
  How to use the Python Scripting API in iTerm2 to open several tabs and execute
  commands in those tabs.
draft: false
featured: false
publishedAt: 08/28/2021
relatedArticles:
  - 2022/a-far-too-in-depth-guide-to-ssh-for-web-developers
  - 2021/migrating-from-yarn-to-pnpm
  - 2021/how-to-kill-processes-on-macos
  - 2018/writing-a-connect-four-game-reader-in-python
  ...
  - 2017/up-and-running-with-iterm-and-zsh
...
import image1 from './prompt-1.png'
import image2 from './prompt-2.png'
...
```python showLineNumbers title="iterm_script.py"
