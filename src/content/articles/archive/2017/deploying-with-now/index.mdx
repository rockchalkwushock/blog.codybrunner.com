...
archived: true
author: cody-brunner
canonicalURL: https://blog.codybrunner.com/archive/2017/deploying-with-now
categories:
  - technology
coverImage:
...
draft: false
featured: false
publishedAt: 06/02/2017
relatedArticles:
  - archive/2017/automating-with-circleci
  - archive/2017/higher-order-components
  - archive/2017/what-i-learned-relearning-graphql
  - archive/2018/building-a-stopwatch-with-javascript
  - archive/2018/getting-started-with-python3
  - archive/2021/how-to-kill-processes-on-macos
  - archive/2021/migrating-from-yarn-to-pnpm
  - archive/2021/scripting-in-iterm2
  - archive/2022/a-far-too-in-depth-guide-to-ssh-for-web-developers
tags:
  - cli
  - deploy
  - javascript
...
If you are wanting to use pre-built binaries they can be found [here](https://zeit.co/download#cli) as a third option for installation. Now that we have now-cli installed we can get started. From your user directory you can run either `now` or `now login`:
...
```json showLineNumbers title="now.json"
{
	"alias": "nowDep.com",
	"env": {
		"ENV_VAR": "@env_var",
