...
archived: true
author: cody-brunner
canonicalURL: https://blog.codybrunner.com/archive/2017/higher-order-components
categories:
  - technology
coverImage:
  alt: Photo by SVGPorn
  src: https://cdn.svgporn.com/logos/react.svg
createdAt: 05/24/2017
description: A short piece on higher-order-functions in React.
draft: false
featured: false
publishedAt: 05/24/2017
relatedArticles:
  ...
  - archive/2019/building-a-react-project-from-scratch-with-typescript
...
```jsx showLineNumbers title="lib/WithLayout.jsx"
...
```javascript showLineNumbers title="pages/index.js"
import { Component } from 'react'
import WithLayout from '../lib'
