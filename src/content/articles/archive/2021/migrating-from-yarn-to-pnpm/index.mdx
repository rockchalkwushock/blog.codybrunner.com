...
archived: true
author: cody-brunner
canonicalURL: https://blog.codybrunner.com/archive/2021/migrating-from-yarn-to-pnpm
categories:
  - technology
coverImage:
  alt: Photo from SVGPorn
  src: https://cdn.svgporn.com/logos/pnpm.svg
...
<Tweet tweetLink='jaredpalmer/status/1393220729173430272' />
...
```diff showLineNumbers title=".husky/commit-msg"
...
```diff showLineNumbers title=".github/workflows/feature.yml"
    steps:
      - name: Linting
-       run: yarn run eslint
+       run: pnpx eslint
