...
archived: true
author: cody-brunner
canonicalURL: https://blog.codybrunner.com/archive/2021/create-animated-social-icons-with-tailwindcss
categories:
  - technology
coverImage:
...
```tsx showLineNumbers title="components/SocialIcons.tsx"
...
```scss showLineNumbers title="styles/global.scss"
...
```diff showLineNumbers title="tailwind.config.js"
module.exports = {
...
```diff showLineNumbers title="components/SocialIcons.tsx"
import * as React from 'react'
