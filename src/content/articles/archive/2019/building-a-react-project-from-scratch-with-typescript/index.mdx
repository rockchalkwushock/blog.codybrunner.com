...
archived: true
author: cody-brunner
canonicalURL: https://blog.codybrunner.com/archive/2019/building-a-react-project-from-scratch-with-typescript
categories:
  - technology
coverImage:
...
```javascript showLineNumbers title="components/Title.js"
...
```javascript showLineNumbers title="webpack.config.js"
...
Now to test this out you can do a simple color change or play around with the CSS on `Title.js` and see the updates nearly immediately without a page refresh in the browser.
