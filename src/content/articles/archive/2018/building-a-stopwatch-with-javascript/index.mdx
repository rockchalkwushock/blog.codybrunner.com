...
archived: true
author: cody-brunner
canonicalURL: https://blog.codybrunner.com/archive/2018/building-a-stopwatch-with-javascript
categories:
  - technology
coverImage:
...
```html showLineNumbers title="stopwatch.html"
<div class="app">
	<div id="watch"></div>
	<div class="controls">
...
```css showLineNumbers title="stopwatch.html"
.app {
	align-items: center;
...
```javascript showLineNumbers title="stopwatch.html"
setTimeout(() => {
