...
```python showLineNumbers title="black_jack_advice.py"
values = {
    '1': 1,
    '2': 2,
    '3': 3,
...
Dictionaries are similar to objects in JavaScript however they are a little different in how we access the data and I will admit I get yelled at by Python a lot of using dot notation which is no bueno.
