...
relatedArticles:
  - archive/2017/automating-with-circleci
tags:
  - ci-cd
  - nodejs
...
import image1 from './how-to-build-a-telegram-bot-with-node-js/info.png'
import image2 from './how-to-build-a-telegram-bot-with-node-js/start_command.png'
import image3 from './how-to-build-a-telegram-bot-with-node-js/tell_me_a_joke.png'
...
```javascript showLineNumbers title="lib/chuck.js"
...
```javascript showLineNumbers title="lib/utils.js"
...
<Image
	alt='Get started talking with Chuck.'
	class='object-cover'
	fetchpriority='low'
	height={300}
	quality={100}
...
<Image
	alt='Screen with all the info about Chuck.'
	class='object-cover'
	fetchpriority='low'
	height={300}
	quality={100}
...
```yml showLineNumbers title=".circleci/config.yaml"
deploy_bot:
  docker:
