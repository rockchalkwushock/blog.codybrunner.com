...
import image1 from './get-after-it.jpg'
import image2 from './git-commit-meme.png'
...
<Image
	alt="My new coffee mug with Jocko's message on it 'Get After It!'"
	class='object-cover'
	fetchpriority='low'
	height={300}
	quality={100}
