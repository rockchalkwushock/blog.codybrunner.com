...
archived: true
author: cody-brunner
canonicalURL: https://blog.codybrunner.com/archive/2018/writing-a-connect-four-game-reader-in-python
categories:
  - technology
coverImage:
...
relatedArticles:
  - archive/2018/building-a-black-jack-advice-generator-with-python
  - archive/2018/getting-started-with-python3
  - archive/2018/recursion-memoization-in-python
  - archive/2021/scripting-in-iterm2
tags:
  - python
...
A recent assignment handed out in the boot camp I'm a part of, [PDX Code Guild](https://pdxcodeguild.com/), was to desgin a program that could read a file full of moves for populating a Connect Four game board. The following post is a walk through of how I solved this problem.
