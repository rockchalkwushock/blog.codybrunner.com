...
archived: true
author: cody-brunner
canonicalURL: https://blog.codybrunner.com/archive/2018/recursion-memoization-in-python
categories:
  - technology
coverImage:
...
```python showLineNumbers title="fibonacci.py"
if n < 2:
  return n
```
