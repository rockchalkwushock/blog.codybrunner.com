...
export default {
  ...
  theme: {
    ...
    typography: theme => ({
			...
			DEFAULT: {
				css: {
					'--tw-prose-body': theme('colors.primary.600'),
					...
					'--tw-prose-code-bg': theme('colors.primary.300 / 0.2'),
					...
					'--tw-prose-invert-body': theme('colors.primary.400'),
					'--tw-prose-invert-headings': theme('colors.primary.200'),
					...
					'--tw-prose-invert-pre-border': theme('colors.primary.200 / 0.1'),
					'--tw-prose-invert-th-borders': theme('colors.primary.700'),
					'--tw-prose-invert-td-borders': theme('colors.primary.800'),
